            ...
            <Container className="!px-0">
                <nav className="shadow-md md:shadow-none bg-[color:var(--card)] md:bg-transparent mx-auto flex justify-between items-center py-2 px-5 md:py-10 backdrop-blur">
                    ...
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <span className="manrope text-4xl font-semibold text-foreground cursor-pointer">
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        ...
                        <button
                            onClick={toggleMenu}
                            type="button"
                            className="bg-muted text-foreground focus:outline-none rounded-full w-10 h-10 flex items-center justify-center"
