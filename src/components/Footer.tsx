    ...
    return (
        <footer className="bg-[color:var(--hero-background)] text-foreground py-10 border-t border-border">
            ...
            <div className="mt-8 md:text-center text-foreground-accent px-6">
                ...
                <p className="text-sm mt-2">Made with &hearts; by <a href="https://nexilaunch.com" target="_blank">Nexi Launch</a></p>
                <p className="text-sm mt-2">UI kit by <a href="https://ui8.net/youthmind/products/fintech-finance-mobile-app-ui-kit" target="_blank">Youthmind</a></p>
            </div>
        </footer>
    );
};
